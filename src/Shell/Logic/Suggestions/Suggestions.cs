...
namespace Dotnet.Shell.Logic.Suggestions
{
    ...
    public class Suggestion
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                var b = (obj as Suggestion);
                return FullText == b.FullText && CompletionText == b.CompletionText && Index == b.Index;
            }
            return false;
        }
        ...
        {
            return (FullText.Text + CompletionText + Index).GetHashCode();
        }
    }
    ...
    class Suggestions
    {
        ...
        public Suggestions(API.Shell shell)
        {
            commandsInPath = Task.Run(() =>
            {
                ...
                {
                    // add all files both with and without their full path
